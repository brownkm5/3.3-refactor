...
var somethingCool = doSomethingCool();
  // -----------------------------------------------
...
// setTimeout(sayHi, 2000);
  ...
  // Put your answer below -------------------------
//The answer is c, z then y, because letter is set to 'x' then set to 'z' and then it is logged.
//It logs 'z' before 'y' because the function makes the console.log 'y' wait a millisecond before initiating
...
var returnValue = reverseStr("kevin");
